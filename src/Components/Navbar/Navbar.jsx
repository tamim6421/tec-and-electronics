...
>
  Contact Us
   ...
   return (
    <div>
        <div className="navbar shadow-lg px-5 font-semibold  text-yellow-400 ">
...
<div className="dropdown">
  ...
  <ul tabIndex={0} className="menu menu-sm dropdown-content mt-3 z-[1] p-2 shadow bg-base-100 rounded-box w-29">
   {links}
